...
class SelfSupervisedExperimentalTraining(LightningModule):
    ...
    def configure_optimizers(self):  # type: ignore
        ...
        param_group = [
            {"params": self.model.parameters(), "lr": self.optimizer_config.max_lr * 0.1},
            {"params": self.sol_model.parameters(), "lr": self.optimizer_config.max_lr},
        ]
        ...
        scheduler = optim.lr_scheduler.OneCycleLR(
            optimizer,
            max_lr=[pg["lr"] for pg in param_group],
            total_steps=self.epochs,
            pct_start=0.2,
            base_momentum=0.9,
            max_momentum=0.95,
