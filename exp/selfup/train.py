...
from g2pt.data.datasets.selfsup import SelfSupervisedDataModule
from g2pt.training.callbacks.grad_norm import GradNormMonitor
from g2pt.training.selfsup import SelfSupervisedTraining

@hydra.main(version_base=None, config_path="../conf", config_name="selfsup")
def main(cfg):
    L.seed_everything(cfg.seed)
    torch.set_float32_matmul_precision("high")

    model = SelfSupervisedTraining(cfg)
    data_module = SelfSupervisedDataModule(cfg)
