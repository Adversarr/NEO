...
from g2pt.utils.gev import outer_cosine_similarity, solve_gev_from_subspace_cuda, solve_gev_ground_truth, qr_orthogonalization
...
def main():
    ...
    for i, case in enumerate(folders):
        ...
        print(f"Point cloud laplacian time: {perf_counter() - _start:.4f}s")
