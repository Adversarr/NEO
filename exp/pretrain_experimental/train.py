...
from g2pt.training.pretrain_experimental import PretrainTraining_Experimental
from g2pt.data.datasets.pretrain_datamod import PretrainDataModule
...
@hydra.main(version_base=None, config_path="../conf", config_name="pretrain_experimental")
def main(cfg):
    L.seed_everything(cfg.seed)
    torch.set_float32_matmul_precision("high")

    model = PretrainTraining_Experimental(cfg)
